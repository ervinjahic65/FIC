;(function() {
    ...
    var form_locale = {
        ...
        id: {
            ...
            btn_step_2: "Mulai sekarang",
            loading: "Memuat...",
            terms: '<input class="form-check-input" type="checkbox" checked id="terms-checkbox" style="width:auto;height:auto;"> Saya telah membaca dan setuju dengan <a href="terms.html" target="_blank">Syarat dan Ketentuan</a>, dan <a href="privacy.html" target="_blank">Kebijakan Privasi</a>',
            thanksmsg: "Terima kasih telah mendaftar! Sebuah email dengan tautan aktivasi telah dikirim ke alamat email yang Anda berikan."
        }
    };
